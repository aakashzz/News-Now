...
function ShortArticles({date, description, author, sourceName, link}) {
  const newDate = date.slice(0,10)
  function goToLink(){
    return window.open(link,"_blank")
  }
  return (
    <div onClick={goToLink} className='border cursor-pointer h-40 w-80 my-4 bg-gray-200 mx-2 rounded-2xl hover:shadow-2xl duration-200 '>
